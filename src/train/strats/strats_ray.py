...
from src.train.strats.strats_train_pl import StratsPretrainTuneConfig, train_strats


@hydra.main(version_base=None, config_name="strats_pretrain_tune_config")
def strats_ray_app(cfg: StratsPretrainTuneConfig):
    ...
    _ = StratsModule.load_from_checkpoint(
...
if __name__ == "__main__":
    # python -m src.train.strats.strats_ray dataloader_config.num_cpus=8
    logging.basicConfig()
