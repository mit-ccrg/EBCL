...
def ebcl_finetune_ray_app(cfg: EbclFinetuneConfig):
    ...
    ebcl_model = EBCLModule.load_from_checkpoint(cfg=cfg.model_config, checkpoint_path=best_checkpoint_dir + "/checkpoint.ckpt")
...
if __name__ == "__main__":
    # python -m src.train.ebcl.ebcl_finetune_ray dataloader_config.encounter_set=MORTALITY logger_config.name=mortality_finetune_ebcl_ray
    logging.basicConfig()
