...
from src.train.ebcl.ebcl_train_pl import EbclPretrainTuneConfig, train_ebcl


@hydra.main(version_base=None, config_name="ebcl_pretrain_tune_config")
def ebcl_ray_app(cfg: EbclPretrainTuneConfig):
    ...
    _ = EBCLModule.load_from_checkpoint(
...
if __name__ == "__main__":
    # python -m src.train.ebcl.ebcl_ray dataloader_config.num_cpus=8
    logging.basicConfig()
